...
class Vegetables : AppCompatActivity(), ItemAdapter.OnItemClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_vegatables)
        Paper.init(this)
        // Initialize data.
...
//                toolbar.setBackgroundColor(resources.getColor(R.color.colorPrimary))
    ...
    fun readData(){
        ...
        var myRef = database.getReference("Item/Vegetables/")
        ...
        myRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(dataSnapshot : DataSnapshot) {
                ...
                for ( childDataSnapshot : DataSnapshot in dataSnapshot.getChildren()) {
                    myRef = database.getReference("Item/Vegetables/"+ childDataSnapshot.getKey().toString())
