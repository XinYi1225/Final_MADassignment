...
class Fruit : AppCompatActivity(), ItemAdapter.OnItemClickListener,
...
//        Log.i("checkObj", myDataset[position].toString())
        ...
        myIntent.putExtra("category", "Fruit")
...
//                toolbar.setBackgroundColor(resources.getColor(R.color.colorPrimary))
    ...
    fun readData(){
        ...
        var myRef = database.getReference("Item/Fruit/")
        ...
        myRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(dataSnapshot : DataSnapshot) {
                ...
                for ( childDataSnapshot : DataSnapshot in dataSnapshot.getChildren()) {
                    myRef = database.getReference("Item/Fruit/"+ childDataSnapshot.getKey().toString())
